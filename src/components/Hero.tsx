  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-purple-200/30 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
        
        {/* Floating Elements */}
        <div className="absolute top-1/4 right-1/4 text-blue-400/20 animate-bounce" style={{animationDelay: '1s'}}>
          <Code size={32} />
        </div>
        <div className="absolute bottom-1/3 left-1/4 text-purple-400/20 animate-bounce" style={{animationDelay: '3s'}}>
          <Sparkles size={28} />
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center lg:text-left space-y-8 order-1 lg:order-2">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-3">
                {['React.js', 'JavaScript', 'TypeScript', 'Tailwind CSS', 'Node.js'].map((tech, index) => (
                  <span 
                    key={tech} 
                    className="px-4 py-2 bg-white/80 backdrop-blur-sm text-gray-700 text-sm font-medium rounded-xl border border-gray-200 shadow-sm hover:shadow-md hover:scale-105 transition-all duration-200"
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-8">
              <Button 
                ...
                size="lg" 
                className="group bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
              ...
              <Button 
                ...
                variant="outline" 
                size="lg" 
                className="group border-2 border-gray-300 hover:border-blue-600 hover:bg-blue-50 px-8 py-4 rounded-xl transition-all duration-300 backdrop-blur-sm bg-white/80 shadow-lg hover:shadow-xl"
              >
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
          <button 
            ...
            className="flex flex-col items-center space-y-2 text-gray-400 hover:text-blue-600 transition-colors duration-300 group"
          >
